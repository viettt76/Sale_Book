                ...
                {orders?.map((order) => {
                    return (
                        <div key={`order-${order?.orderId}`} className={clsx(styles['order-item'])}>
                            <div className={clsx(styles['order-status'])}>{order?.status}</div>
                            <div className={clsx(styles['order-book-info'])}>
                                ...
                                <div className={clsx(styles['order-book-name-quantity'])}>
                                    ...
                                    <div className={clsx(styles['order-book-quantity'])}>x {order?.quantity}</div>
                                </div>
                                <div className={clsx(styles['order-book-price'])}>
                            ...
                            <div className={clsx(styles['order-footer'])}>
                                ...
                                <div>
                                    ...
                                    <div className={clsx(styles['order-action'])}>
                                        ...
                                        <Link to={`/book/${order?.bookId}`} className={clsx(styles['order-buy-back'])}>
                                            Mua lại
                                        </Link>
                                    </div>
                                </div>
