...
namespace BookStore.Datas.DbContexts
{
  ...
  },new Cart
  {
    ...
    Quantity =  18
                ...
                // OrderItem
                //var orderItemDatas = File.ReadAllText("../BookStore.Datas/DbContexts/OrderItem.json");
                //var orderItems = JsonSerializer.Deserialize<List<OrderItem>>(orderItemDatas);
